...
// RolesRepository wrap for declaring handlers as methods of it
type RolesRepositoryWrap struct {
...
func handleError(err error, w http.ResponseWriter) {
	...
	if errors.As(err, &queryErr) {
		...
		error = models.Error{http.StatusInternalServerError, "Internal server error"}
	}
...
func (repository *RolesRepositoryWrap) GetAllRoles(w http.ResponseWriter, r *http.Request) {
...
func (repository *RolesRepositoryWrap) GetRole(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (repository *RolesRepositoryWrap) CreateRole(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (repository *RolesRepositoryWrap) UpdateRole(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (repository *RolesRepositoryWrap) DeleteRole(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (repository *RolesRepositoryWrap) GetRoleTemplate(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
